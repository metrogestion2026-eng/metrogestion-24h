  ...
  function modal(){
    ...
    m.innerHTML=`<div id="v39-assign-sheet">
      ...
      <div class="grid" style="margin-top:12px">
        <label>DFM / matrícula del sustituido<input id="v39-assign-vehicle" class="form-control" list="v39-assign-vehicles" autocomplete="off" placeholder="Ej. 2490 o TEST-4758aa77"><datalist id="v39-assign-vehicles"></datalist></label>
