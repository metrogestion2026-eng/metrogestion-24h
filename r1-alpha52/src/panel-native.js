...
async function renderPanel({ automatic = false } = {}) {
  ...
  try {
    ...
    const hotelMetrics = [
      { label: 'Fichas activas', value: hotelRows.length, hint: 'Toda la pizarra', tone: 'main', detail: { title: 'Fichas activas', items: hotelRows.map(hotelItem), module: 'hotel', moduleLabel: 'Abrir Hotel' } },
      { label: 'Pendientes de parar', value: planned.length, tone: 'yellow', detail: { title: 'Pendientes de parar', items: planned.map(hotelItem), module: 'hotel', moduleLabel: 'Abrir Hotel' } },
      { label: 'Pendientes de taller', value: pendingWorkshop.length, tone: 'neutral', detail: { title: 'Pendientes de taller', items: pendingWorkshop.map(hotelItem), module: 'hotel', moduleLabel: 'Abrir Hotel' } },
      { label: 'En taller', value: inWorkshop.length, tone: 'lilac', detail: { title: 'En taller', items: inWorkshop.map(hotelItem), module: 'hotel', moduleLabel: 'Abrir Hotel' } },
      { label: 'Pendientes de recoger', value: pendingPickup.length, tone: 'blue', detail: { title: 'Pendientes de recoger', items: pendingPickup.map(hotelItem), module: 'hotel', moduleLabel: 'Abrir Hotel' } },
      { label: 'Pendientes de recuperar', value: pendingRecover.length, tone: 'orange', detail: { title: 'Pendientes de recuperar', items: pendingRecover.map(hotelItem), module: 'hotel', moduleLabel: 'Abrir Hotel' } },
    ];
