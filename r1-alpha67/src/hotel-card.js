...
import { createQuickStageControl } from './stage-quick.js';
import {
  STATE_LABELS,
  STAGE_STATE_LABELS,
  formatDateTime,
...
function stageVisual(stage) {
  ...
  return {
    ...
    label: STAGE_STATE_LABELS[stage.estado] || stage.estado || 'Pendiente',
  };
}
...
export function renderHotelCard(row, stages, documentsByGroup, {
  editMode,
  editableIds,
  canEditDocuments,
  onOpenEditor,
  ...
  if (row.observaciones) {
    card.append(element('section', { className: 'hotel-final-notes' }, [
