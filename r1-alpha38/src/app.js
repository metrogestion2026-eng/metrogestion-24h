...
const FIXED_LOCATIONS={
  abrera:{
    plus:'GV6V+62 Abrera',
    coordinates:'41.510562, 1.892562'
  },
  sansa:{
    plus:"CRJ3+HG Sant Sadurní d'Anoia",
    coordinates:'41.431438, 1.803813'
  },
  disfrimur:{
    plus:"CRM4+G2 Sant Sadurní d'Anoia",
    coordinates:'41.433813, 1.805063'
  }
};
...
function patchLocationStep(){
  ...
  if(!formatSelect){
    ...
    formatSelect.value=inferFormat(currentType,input.value);
