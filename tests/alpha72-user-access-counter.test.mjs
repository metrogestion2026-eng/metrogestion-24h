...
assert.match(alpha63Index, /name="metrogestion-release" content="r1\.0\.0-alpha\.73"/);
assert.match(alpha63Index, /src="\.\.\/r1-alpha73\/src\/app\.js"/);
assert.match(alpha63Index, /src="\.\.\/r1-alpha73\/src\/hotel-native\.js"/);
assert.match(alpha63Index, /src="\.\.\/r1-alpha73\/src\/history-native\.js"/);
assert.match(alpha63Index, /src="\.\.\/r1-alpha73\/src\/panel-native\.js"/);
assert.match(alpha69Index, /name="metrogestion-release" content="r1\.0\.0-alpha\.73"/);
assert.match(alpha69Index, /src="\.\.\/r1-alpha73\/src\/app\.js"/);
assert.match(alpha69Index, /src="\.\.\/r1-alpha73\/src\/hotel-native\.js"/);
assert.match(alpha69Index, /src="\.\.\/r1-alpha73\/src\/history-native\.js"/);
assert.match(alpha69Index, /src="\.\.\/r1-alpha73\/src\/panel-native\.js"/);

console.log('Alpha73: marcador de accesos y enlaces heredados de usuarios verificados.');
