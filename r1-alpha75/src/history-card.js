...
import { openHotelEditor } from './hotel-editor.js?v=75.10';
...
function stageStatus(stage) {
  ...
  if (stage.estado_catalogo_codigo && stage.estado_catalogo_codigo !== stage.estado) return stage.estado_catalogo_codigo;
  return ({
    pendiente: 'Pendiente',
